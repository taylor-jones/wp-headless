...
function register_custom_post_types() {
  ...
  register_post_type('opportunity', array(
    'can_export'            => true,
    'capability_type'       => 'post',
    'description'           => __( 'An opportunity to get involved at Synergy In Action', SIA_CPT_DOMAIN ),
    'exclude_from_search'   => false,
    'graphql_plural_name'   => 'opportunities',
    'graphql_single_name'   => 'opportunity',
    'has_archive'           => true,
    'hierarchical'          => false,
    'label'                 => __( 'Opportunity', SIA_CPT_DOMAIN ),
    'labels'                => array(
        'name'                  => _x( 'Opportunities', 'Post Type General Name', SIA_CPT_DOMAIN ),
        'singular_name'         => _x( 'Opportunity', 'Post Type Singular Name', SIA_CPT_DOMAIN ),
        'menu_name'             => __( 'Opportunities', SIA_CPT_DOMAIN ),
        'name_admin_bar'        => __( 'Opportunities', SIA_CPT_DOMAIN ),
        'archives'              => __( 'Opportunity Archives', SIA_CPT_DOMAIN ),
        'attributes'            => __( 'Opportunity Attributes', SIA_CPT_DOMAIN ),
        'parent_item_colon'     => __( 'Parent Opportunity:', SIA_CPT_DOMAIN ),
        'all_items'             => __( 'All Opportunities', SIA_CPT_DOMAIN ),
        'add_new_item'          => __( 'Add New Opportunity', SIA_CPT_DOMAIN ),
        'add_new'               => __( 'Add New', SIA_CPT_DOMAIN ),
        'new_item'              => __( 'New Opportunity', SIA_CPT_DOMAIN ),
        'edit_item'             => __( 'Edit Opportunity', SIA_CPT_DOMAIN ),
        'update_item'           => __( 'Update Opportunity', SIA_CPT_DOMAIN ),
        'view_item'             => __( 'View Opportunity', SIA_CPT_DOMAIN ),
        'view_items'            => __( 'View Opportunities', SIA_CPT_DOMAIN ),
        'search_items'          => __( 'Search Opportunities', SIA_CPT_DOMAIN ),
        'not_found'             => __( 'Not found', SIA_CPT_DOMAIN ),
        'not_found_in_trash'    => __( 'Not found in Trash', SIA_CPT_DOMAIN ),
        'featured_image'        => __( 'Featured Image', SIA_CPT_DOMAIN ),
        'set_featured_image'    => __( 'Set featured image', SIA_CPT_DOMAIN ),
        'remove_featured_image' => __( 'Remove featured image', SIA_CPT_DOMAIN ),
        'use_featured_image'    => __( 'Use as featured image', SIA_CPT_DOMAIN ),
        'insert_into_item'      => __( 'Insert into Opportunity', SIA_CPT_DOMAIN ),
        'uploaded_to_this_item' => __( 'Uploaded to this Opportunity', SIA_CPT_DOMAIN ),
        'items_list'            => __( 'Opportunities list', SIA_CPT_DOMAIN ),
        'items_list_navigation' => __( 'Opportunities list navigation', SIA_CPT_DOMAIN ),
        'filter_items_list'     => __( 'Filter Opportunities list', SIA_CPT_DOMAIN ),
    ),
    'menu_position'         => 30,
    ...
    'rewrite'               => array(
      'slug'                  => _x('opportunity', 'post type slug', SIA_CPT_DOMAIN),
      'with_front'            => true,
    ),
    'show_in_admin_bar'     => true,
    'show_in_nav_menus'     => false,
    ...
    'taxonomies'            => array( 'opportunity-category' ),
  ));
